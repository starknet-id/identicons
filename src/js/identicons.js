...
<path fill="none" stroke="${color}" stroke-width="${
      2 * strokeWidth
    }" transform="translate(0, 8) scale(0.5)" d="M251.6 17.34l63.53 110.03c5.72 9.9 5.72 22.1 0 32L251.6 269.4c-5.7 9.9-16.27 16-27.7 16H96.83c-11.43 0-22-6.1-27.7-16L5.6 159.37c-5.7-9.9-5.7-22.1 0-32L69.14 17.34c5.72-9.9 16.28-16 27.7-16H223.9c11.43 0 22 6.1 27.7 16z"/>
...
<g opacity=".1" fill="#010101"><path d="M119.21,80a39.46,39.46,0,0,1-67.13,28.13c10.36,2.33,36,3,49.82-14.28,10.39-12.47,8.31-33.23,4.16-43.26A39.35,39.35,0,0,1,119.21,80Z"/></g>
  ...
  static placeholderToDataUrl(color, strokeWidth) {
    return `data:image/svg+xml;base64,${this._btoa(
      this.placeholder(color, strokeWidth)
    )}`;
  }
...
${await this._generatePart("bottom", bottomNr)}
  ...
  static _$svg(content) {
    ...
    <defs><clipPath id="rectangle-clip-${randomId}">
    <rect x="0" y="0" width="160" height="160" rx="20" ry="20"/>
    </clipPath></defs>
    <g clip-path="url(#rectangle-clip-${randomId})">
    ${content}
    </g></svg>`;
  }
  ...
  static async _getAssets() {
    return (
      this._assetsPromise ||
      (this._assetsPromise = new Promise(async function (resolve) {
        let assetsText;
        if (typeof IdenticonsAssets !== "undefined")
          assetsText = IdenticonsAssets; // Check for inlined assets
        else
          assetsText = await fetch(
            self.NIMIQ_IDENTICONS_SVG_PATH || Identicons.svgPath
